...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__BootstrapDemo_scss__ = __webpack_require__("./pages/bootstrap/BootstrapDemo.scss");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__BootstrapDemo_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__BootstrapDemo_scss__);
...
function (_Component) {
  ...
  function BootstrapDemo() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = BootstrapDemo.__proto__ || Object.getPrototypeOf(BootstrapDemo)).call.apply(_ref, [this].concat(args))), _this.state = {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_3__components_Dialog__["a" /* confirm */])('this is test message', function (result) {
        if (result) {
  ...
  _createClass(BootstrapDemo, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: __WEBPACK_IMPORTED_MODULE_4__BootstrapDemo_scss___default.a.container,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 38
        }
...
//# sourceMappingURL=5.ac2b6e9a4bbeac046341.hot-update.js.map